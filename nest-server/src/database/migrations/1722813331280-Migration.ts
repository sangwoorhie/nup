...
export class Migration1722813331280 implements MigrationInterface {
    name = 'Migration1722813331280'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Refund_request" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "requested_point" integer NOT NULL, "rest_point" integer NOT NULL, "account_holder_name" character varying, "bank_account_copy" character varying NOT NULL, "refund_request_reason" character varying NOT NULL, "is_refunded" boolean NOT NULL DEFAULT false, "is_cancelled" boolean NOT NULL DEFAULT false, "requested_at" date NOT NULL DEFAULT now(), "cancelled_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_e69d70afb2d0c93e7aad03aa8e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Corporates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "corporate_name" character varying NOT NULL, "business_type" character varying NOT NULL, "business_conditions" character varying NOT NULL, "business_registration_number" integer NOT NULL, "business_license" character varying NOT NULL, "business_license_verified" boolean NOT NULL DEFAULT false, "address" character varying NOT NULL, "created_at" date NOT NULL DEFAULT now(), "updated_at" date NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "REL_564d666bfb762c6f1089e93e09" UNIQUE ("user_id"), CONSTRAINT "PK_e1df2f910f55b07c3adba6ca55e" PRIMARY KEY ("id"))`);
